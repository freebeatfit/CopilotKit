 ...
 *
 * ```tsx
 * import { useCoAgent } from "@freebeatfit/react-core";
 *
 * type AgentState = {
 *   count: number;
 * }
...
import { Message } from "@freebeatfit/shared";
import { useAsyncCallback } from "../components/error-boundary/error-utils";
import { useToast } from "../components/toast/toast-provider";
import { useCopilotRuntimeClient } from "./use-copilot-runtime-client";
import { parseJson, CopilotKitAgentDiscoveryError } from "@freebeatfit/shared";
import { useMessagesTap } from "../components/copilot-provider/copilot-messages";
import { Message as GqlMessage } from "@freebeatfit/runtime-client-gql";
