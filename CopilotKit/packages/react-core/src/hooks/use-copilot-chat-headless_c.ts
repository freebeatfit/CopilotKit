 ...
 *
 * ```tsx
 * import { CopilotKit } from "@freebeatfit/react-core";
 * import { useCopilotChatHeadless_c } from "@freebeatfit/react-core";
 *
 * export function App() {
 *   return (
 ...
 *
 * ```tsx
 * import { useCopilotChatHeadless_c, useCopilotChatSuggestions } from "@freebeatfit/react-core";
 *
