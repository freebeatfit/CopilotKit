...
import { useCopilotContext, useCopilotMessagesContext } from "@freebeatfit/react-core";
import {
...
import { COPILOTKIT_VERSION } from "@freebeatfit/shared";
...
function VersionInfo({
  ...
  const installCommand = [
    `npm install`,
    `@freebeatfit/react-core@${latestVersion}`,
    `@freebeatfit/react-ui@${latestVersion}`,
    `@freebeatfit/react-textarea@${latestVersion}`,
    `&& npm install @freebeatfit/runtime@${latestVersion}`,
  ].join(" ");
