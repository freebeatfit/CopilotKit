...
import { convertJsonSchemaToZodSchema, randomId, CopilotKitMisuseError } from "@freebeatfit/shared";
 ...
 *
 * ```bash
 * npm install @freebeatfit/sdk-js
 * ```
 *
 * ### Examples
 *
 ...
 *
 * ```typescript
 * import { copilotkitCustomizeConfig } from "@freebeatfit/sdk-js";
 *
 ...
 *
 * ```typescript
 * import { copilotkitExit } from "@freebeatfit/sdk-js";
 *
 ...
 *
 * ```typescript
 * import { copilotkitEmitState } from "@freebeatfit/sdk-js";
 *
 * for (let i = 0; i < 10; i++) {
 ...
 *
 * ```typescript
 * import { copilotkitEmitMessage } from "@freebeatfit/sdk-js";
 *
 ...
 *
 * ```typescript
 * import { copilotkitEmitToolCall } from "@freebeatfit/sdk-js";
 *
 ...
 *
 * ```typescript
 * import { convertActionsToDynamicStructuredTools } from "@freebeatfit/sdk-js";
 *
